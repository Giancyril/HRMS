                            ...
                            <div class="card-body">
                                        <form method="post" action="<?php echo base_url();?>organization/Update_dep" enctype="multipart/form-data">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <a href="<?php echo base_url();?>organization/Department" class="btn btn-danger">Cancel</a>
                                            </div>
                                        </form>
                            </div>
                        </div>
                ...
                $('#editDepartmentForm').on('submit', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            }, 500); // Adjust this delay (milliseconds) as desired before closing and reloading
                        },
                        error: function(xhr, status, error) {
                            ...
                            setTimeout(function() {
                                $('#editDepartmentModal').modal('hide');
                                location.reload();
                            }, 500); // Adjust this delay (milliseconds) for error case as desired
                        }
                    });
                });
            });
