...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2025 at 12:53 AM
...
(11, 11, '7000.00', '700.00', '5600.00', '700.00'),
(12, 12, '6500.00', '650.00', '5200.00', '650.00');
...
(1, 'Doe1753', 'Manolo Fortich', 'Philippines', 'Tankulan', 'Permanent'),
(2, 'Doe1753', 'Manolo Fortich', 'Philippines', 'Tankulan', 'Present'),
(3, 'Soy1332', 'Manolo Fortich', 'Philippines', 'San Miguel', 'Permanent'),
(4, 'Soy1332', 'Manolo Fortich', 'Philippines', 'San Miguel', 'Present');
...
(3, 2, 3, '', 'Team Head'),
(4, 2, 3, 'Aec1364', 'Collaborators'),
(5, 2, 3, 'Jam1525', 'Collaborators'),
(6, 3, 3, '', 'Team Head'),
(7, 4, 3, 'Jam1525', 'Team Head'),
(8, 4, 3, 'Aec1364', 'Collaborators');
...
(1, 'Doe1754', 'Cyril Naig', 'XYZ Bank', 'Bleck St', 'CA0025869690', 'Saving'),
(2, 'Doe1753', 'Clint Mark', 'ABYZ Bank', 'Axis Branch', 'CA6960000142', 'Current'),
(11, 'Aec1364', 'John Aech', 'IOP Bank', 'AER Branch', 'CA1241812378', 'Salary Account'),
(12, 'Jam1525', 'Adrian James', 'ADI Bank', 'ADI ST', 'CA1241816351', 'Salary Account');
...
(2, 'Soy1332', 'Bachelor of Science in Information Technology', 'Mindanao State University - Main Campus', 'Magna Cum Laude', '2024');
...
CREATE TABLE `employee` (
  ...
  `em_role` enum('EMPLOYEE','HR-MANAGER','ADMIN') DEFAULT NULL,
...
(10, 'Soy1332', '99', 2, 2, 'Gian', 'Cyril', 'gian@gmail.com', '996a3778768a2c3ea7c5b586fdfc92051dfdd39c', 'ADMIN', NULL, 'ACTIVE', 'Male', '01723177901', '2025-04-28', 'B+', '2025-01-08', '2026-10-20', 'Soy1332.jpg', '132154566556'),
(36, 'Doe1753', '123456', 2, 2, 'Clint', 'Mark', 'hr@gmail.com', '50ebd8e22dda98d19b42d4b82a35605768c09814', 'HR-MANAGER', NULL, 'ACTIVE', 'Male', '1234567788', '2019-02-13', 'O+', '2025-05-10', '2025-05-09', 'Doe1753.jpg', '01253568955555'),
(37, 'Doe1754', '123444', 4, 4, 'Cyril', 'Naig', 'cyril@gmail.com', '36278d57ae43f28ef4c5811409fadad6144e9e73', 'EMPLOYEE', NULL, 'ACTIVE', 'Male', '09122374569', '2019-02-13', 'O+', '2025-05-09', '2025-05-09', 'Doe1754.jpg', '01253568955555'),
(38, 'Aec1364', '1058', 3, 3, 'Jhon', 'Aech', 'john@gmail.com', '9c9cc4f9982af7dc2a2af8afad95ba3c138ce328', 'EMPLOYEE', NULL, 'ACTIVE', 'Male', '09562849143', '1999-12-22', 'O+', '2025-05-13', '2025-05-09', 'Aec1364.jpg', '3416747824'),
(0, 'Jam1525', '8692', 5, 5, 'Adrian', 'James', 'adrian@gmail.com', 'a0dd2ffd3a4699fabd2f3581874cbeaa074051c2', 'HR-MANAGER', NULL, 'ACTIVE', 'Male', '09748562854', '2005-12-12', 'A+', '2025-05-16', '2025-05-16', 'Jam1525.jpg', '5648172491');
...
(3, 'Soy1332', 'Employee ID Card', 'script1.pdf');
...
(1, 'Soy1332', 'Thinkpad', 'IT Specialist', '102 Blue St', '8 Hours');
...
(6, 'Jam1525', 2, 'More than One day', '2025-05-15', '2025-05-30', '120', '2025-05-17', 'I am feeling unwell and unable to work.', 'Not Approve');
...
(1, '3', 'Aec1364', 'Office', '2025-05-18', '2025-05-25', '7', 'Authorization requested for field work related to the Cybersecurity Enhancement Project.', '', 'Not Approve', '');
...
(1, 'New Year\'s Eve', '2025-12-30', '2025-12-31', '1', '12-2025'),
(3, 'New Year\'s Day', '2025-01-01', '2025-01-02', '1', '01-2025'),
(5, 'Christmas', '2025-12-25', '2025-12-25', '0', '12-2025'),
(7, 'Halloween', '2025-11-01', '2025-11-01', '0', '11-2025');
...
(1, 'Doe1753', '65000', NULL, NULL, '21666', '43334', '10833', '19073382', 'this is a demo loan test for demo purpose', '2021-04-20', '4', 'Granted');
...
(33, 1, 'Doe1753', '19073382', '10833', NULL, '2025-05-28', NULL, '4', NULL);
...
(4, 'IT Tip - Remember to Lock Your Computer When Away', 'IT-TIP.jpg', '2025-05-17'),
(5, 'IT Maintenance - May 2025', 'IT_Maintenance_-_May_2025.pdf', '2025-05-19');
...
INSERT INTO `pay_salary` (`pay_id`, `emp_id`, `type_id`, `month`, `year`, `paid_date`, `total_days`, `basic`, `medical`, `house_rent`, `bonus`, `bima`, `tax`, `provident_fund`, `total_pay`, `addition`, `diduction`, `status`, `paid_type`, `loan`) VALUES
(7, 'Aec1364', 0, 'May', '2025', '2025-05-30', '54', '14000', NULL, NULL, NULL, NULL, NULL, NULL, '3634.74', 0, 10366, 'Paid', 'Hand Cash', NULL),
(8, 'Doe1753', 0, 'May', '2025', '2025-05-28', '46', '13500', NULL, NULL, NULL, NULL, NULL, NULL, '-7847.60', 0, 21347, 'Paid', 'Hand Cash', NULL),
(9, 'Doe1754', 0, 'May', '2025', '2025-05-30', '54', '5500', NULL, NULL, NULL, NULL, NULL, NULL, '1427.76', 0, 4072, 'Paid', 'Hand Cash', NULL),
(10, 'Jam1525', 0, 'May', '2025', '2025-05-29', '44', '13000', NULL, NULL, NULL, NULL, NULL, NULL, '2750.00', 0, 10250, 'Paid', 'Hand Cash', '0');
...
(3, 'Cybersecurity Enhancement Project', '05/17/2025', '05/31/2025', 'Implementing new security protocols, tools, and training to enhance the organization\'s cybersecurity posture.', 'Security Analyst, IT Manager', 'running', NULL),
(4, 'Employee Performance Management System Implementation', '05/17/2025', '05/17/2025', 'Rolling out a new platform for performance reviews and goal setting.', 'Key Personnel Involved: HR Manager, HR Generalist, IT Specialist', 'running', NULL),
(5, 'Cloud Migration Strategy and Implementation', '05/17/2025,05/17/2025', '05/17/2025,05/17/2025', 'Planning and executing the migration of selected applications and data to the cloud.', 'Cloud Architect, System Admins', 'upcoming', NULL),
(7, 'Network Infrastructure Upgrade', '06/17/2025', '06/30/2025', ' Upgrading core network switches and routers to improve performance and security.', 'Network Engineer, IT Manager', 'running', NULL),
(8, 'IT Infrastructure Upgrade', '06/01/2025', '08/31/2025', ' Upgrade company network (routers, switches, Wi-Fi in Manolo Fortich).', 'Improve IT network performance and security in Manolo Fortich', 'running', NULL);
...
(4, 3, 'Implement Two-Factor Authentication for User Logins (A relevant task for a Cybersecurity Enhancement Project)', '2025-05-17', '2025-05-24', NULL, 'Implement two-factor authentication using TOTP (Time-based One-time Password)', 'Office', 'running', NULL, NULL, NULL, '2025-05-17', '');
...
(1, 'logo113.png', 'Human Resource Management System', 'this HRMS aims to streamline and automate human resource processes within an organization.', 'GenIT', '0001110000', 'PHP', '₱', 'hrms@gmail.com', 'Barangay Tankulan', 'Manolo Fortich');
...
(6, 'Soy1332', 'Troubleshoot user login issues', '2025-05-17 12:47:07pm', '1'),
(7, 'Soy1332', 'Implement database schema for leave management', '2025-05-17 12:47:48pm', '1'),
(8, 'Soy1332', 'Design user interface for employee profile module', '2025-05-17 12:48:08pm', '1'),
(9, 'Jam1525', 'Check the attendance reports', '2025-05-18 03:20:39pm', '1'),
(10, 'Jam1525', 'Work on the planning document for the new HR portal.', '2025-05-18 03:20:45pm', '1'),
(11, 'Jam1525', 'Review employee leave applications for the upcoming week.', '2025-05-18 03:20:52pm', '1');
